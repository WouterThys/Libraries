...
//uint16_t * sclOdr;    // Open drain SCL register 
//uint16_t * sdaOdr;    // Open drain SDA register
//uint16_t * sclDir;    // Tri-state SCL register
//uint16_t * sdaDir;    // Tri-state SDA register
...
static uint16_t i2cInterruptCnt;
static uint16_t i2cTestCnt;
